...
import com.mononsoft.bangladesheyehospital.DeviceInfo;
...
/*
 * Created by Md Mehadi Hasan on 9/17/2019.
 * Email: bdmehadih@gmail.com
 * Website: www.mehadih.me
 * Project Name: JMI Pharma
 */
...
public class Tools {
 ...
 /*   public static void displayImageRound(final Context ctx, final ImageView img, @DrawableRes int drawable) {
   ...
   /* public static void displayImageOriginal(Context ctx, ImageView img, String url) {
    ...
    public static String getFormatedDDMMYYYY(Long dateTime) {
        SimpleDateFormat newFormat = new SimpleDateFormat("dd-MM-yyyy");
        return newFormat.format(new Date(dateTime));
    }
    public static String getFormatedMMDDYYYY(Long dateTime) {
